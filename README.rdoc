...
* slim to get experience with it
* friendly_id for putting slugs into individual post urls, replacing id #s
* bootstrap-wysihtml5-rails so users can easily create blog posts
* sanitize to properly format submitted posts
